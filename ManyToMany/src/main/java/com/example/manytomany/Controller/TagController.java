...
public class TagController {
    ...
    public ResponseEntity<List<Tutorial>> getAllTutorialsById(@PathVariable(value = "tagId") Long tagId) {
    ...
    public ResponseEntity<Tag> updateTag(@PathVariable("id") long id, @RequestBody Tag tagRequest) {
        Tag tag = tagRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("TagId" + id + " not found"));
